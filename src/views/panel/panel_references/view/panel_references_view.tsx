...
function PanelReferencesView(){
    ...
    references={["example company","example company","example company","example company","example company","example company","example company","example company","example company","example company"]} />
    </div>
    </>
}
