...
function ContactUsView() {
  ...
  useEffect(() => {
    const asyncGap = async () => {
      setNumber(await viewModel.setPhoneNumber());
    };
    asyncGap();
  });
  return (
        ...
        <section id="contactUsInMain">
          ...
          <div id="inputs">
            <TextInput
              ...
              controllerId="nameInput"
              type="text"
            />
            <div className="sizedBox"></div>
            <TextInput
              title="Telefon Numaranız"
              controllerId="phoneNumberInput"
              type="number"
            />
            <div className="sizedBox"></div>
            <TextInput
              title="E-Mail Adresiniz"
              controllerId="eMailInput"
              type="text"
            />
            <div className="sizedBox"></div>
            <TextAreaInput
              title="Size Nasıl Yardımcı Olabiliriz?"
              controllerId="descriptionInput"
            />
            <div className="sizedBox"></div>
            <div id="buttonArea">
              <CustomButton
                text="Gönder"
                onClick={async () => await viewModel.sendMessage()}
              />
            </div>
          </div>
        </section>
